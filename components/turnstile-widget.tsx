 ...
 * majority of visitors, and only shows a challenge when Cloudflare is
 * unsure the visitor is human. This is what actually stops bots/scripts
 * from submitting the form — `handleSubmit` in `contact.tsx` refuses to
 * send unless the token this widget produces passes server-side
 * verification.
 */
